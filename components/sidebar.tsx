                  ...
                  {category.components.map((component) => {
                    ...
                    return (
                      <Link
                        ...
                        href={href}
                        className={cn(
                          "group hover:text-accent-foreground relative flex h-8 w-full items-center justify-between rounded-lg px-2 font-normal transition-transform duration-200 hover:translate-x-px",
                          isActive
