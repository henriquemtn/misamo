export default function Footer() {
  return (
    <footer className="before:bg-[linear-gradient(to_right,--theme(--color-border/.3),--theme(--color-border)_200px,--theme(--color-border)_calc(100%-200px),--theme(--color-border/.3))] relative py-8 before:absolute before:-inset-x-32 before:top-0 before:h-px">
      <div
